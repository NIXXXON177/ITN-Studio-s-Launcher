...
QString ITNTheme::appStyleSheet()
{
    return QStringLiteral(
        ...
        " color: #04120a; border: 1px solid #14532d; border-radius: 6px; padding: 6px 14px; font-weight: bold; }"
        "QPushButton:hover { background-color: qlineargradient(x1: 0, y1: 0, x2: 0, y2: 1, stop: 0 #4ade80, stop: 1 #16a34a);"
        " border: 1px solid #22c55e; }"
        "QPushButton:pressed { background-color: #15803d; padding-top: 7px; padding-bottom: 5px; }"
        "QToolButton:hover { background-color: rgba(34, 197, 94, 55); border-radius: 4px; }"
        "QToolButton:pressed { background-color: rgba(22, 163, 74, 90); }"
